    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.appointments.update", [$appointment->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contrast') ? 'is-invalid' : '' }}" type="number" name="contrast" id="contrast" value="{{ old('contrast', $appointment->contrast) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('films') ? 'is-invalid' : '' }}" type="number" name="films" id="films" value="{{ old('films', $appointment->films) }}" step="1">
                @if($errors->has('films'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('history') ? 'is-invalid' : '' }}" name="history" id="history">{{ old('history', $appointment->history) }}</textarea>
