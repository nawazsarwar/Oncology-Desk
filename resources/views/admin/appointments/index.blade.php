...
{ data: 'studies', name: 'studies.name' },
{ data: 'start_time', name: 'start_time' },
{ data: 'priority_level_title', name: 'priority_level.title' },
{ data: 'status_title', name: 'status.title' },
{ data: 'reporting_required', name: 'reporting_required' },
{ data: 'contrast', name: 'contrast' },
{ data: 'films', name: 'films' },
{ data: 'investigation_performed_by_name', name: 'investigation_performed_by.name' },
