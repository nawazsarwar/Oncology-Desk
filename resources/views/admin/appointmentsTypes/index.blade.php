...
@can('appointments_type_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.appointments-types.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-AppointmentsType">
            <thead>
                <tr>
                    <th width="10">
...
@can('appointments_type_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.appointments-types.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.appointments-types.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-AppointmentsType').DataTable(dtOverrideGlobals);
