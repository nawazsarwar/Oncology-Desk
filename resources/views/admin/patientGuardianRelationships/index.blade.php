...
@can('patient_guardian_relationship_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.patient-guardian-relationships.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-PatientGuardianRelationship">
            <thead>
                <tr>
                    <th width="10">
...
@can('patient_guardian_relationship_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.patient-guardian-relationships.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.patient-guardian-relationships.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-PatientGuardianRelationship').DataTable(dtOverrideGlobals);
