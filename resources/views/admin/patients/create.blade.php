    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.patients.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('registration_date') ? 'is-invalid' : '' }}" type="text" name="registration_date" id="registration_date" value="{{ old('registration_date') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_mlc_patient') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_mlc_patient" id="is_mlc_patient" value="1" {{ old('is_mlc_patient', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('uhid_number') ? 'is-invalid' : '' }}" type="text" name="uhid_number" id="uhid_number" value="{{ old('uhid_number', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('abha') ? 'is-invalid' : '' }}" type="text" name="abha" id="abha" value="{{ old('abha', '') }}">
                @if($errors->has('abha'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('patient_age_in_years') ? 'is-invalid' : '' }}" type="number" name="patient_age_in_years" id="patient_age_in_years" value="{{ old('patient_age_in_years', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('patient_age_in_months') ? 'is-invalid' : '' }}" type="number" name="patient_age_in_months" id="patient_age_in_months" value="{{ old('patient_age_in_months', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('patient_age_in_days') ? 'is-invalid' : '' }}" type="number" name="patient_age_in_days" id="patient_age_in_days" value="{{ old('patient_age_in_days', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gurdian_name') ? 'is-invalid' : '' }}" type="text" name="gurdian_name" id="gurdian_name" value="{{ old('gurdian_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mlc_number') ? 'is-invalid' : '' }}" type="text" name="mlc_number" id="mlc_number" value="{{ old('mlc_number', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('police_station') ? 'is-invalid' : '' }}" type="text" name="police_station" id="police_station" value="{{ old('police_station', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mlc_remark') ? 'is-invalid' : '' }}" type="text" name="mlc_remark" id="mlc_remark" value="{{ old('mlc_remark', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_referred_patient') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_referred_patient" id="is_referred_patient" value="1" {{ old('is_referred_patient', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('referring_hospital') ? 'is-invalid' : '' }}" type="text" name="referring_hospital" id="referring_hospital" value="{{ old('referring_hospital', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('referring_department') ? 'is-invalid' : '' }}" type="text" name="referring_department" id="referring_department" value="{{ old('referring_department', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('reffered_on') ? 'is-invalid' : '' }}" type="text" name="reffered_on" id="reffered_on" value="{{ old('reffered_on') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('referring_uhid') ? 'is-invalid' : '' }}" type="text" name="referring_uhid" id="referring_uhid" value="{{ old('referring_uhid', '') }}">
