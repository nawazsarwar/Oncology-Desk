...
@can('priority_level_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.priority-levels.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-PriorityLevel">
            <thead>
                <tr>
                    <th width="10">
...
@can('priority_level_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.priority-levels.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.priority-levels.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-PriorityLevel').DataTable(dtOverrideGlobals);
