...
@can('report_statuss_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.report-statusses.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-ReportStatuss">
            <thead>
                <tr>
                    <th width="10">
...
@can('report_statuss_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.report-statusses.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.report-statusses.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-ReportStatuss').DataTable(dtOverrideGlobals);
