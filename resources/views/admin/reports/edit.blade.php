    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.reports.update", [$report->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('text') ? 'is-invalid' : '' }}" name="text" id="text">{!! old('text', $report->text) !!}</textarea>
                @if($errors->has('text'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('summary') ? 'is-invalid' : '' }}" type="text" name="summary" id="summary" value="{{ old('summary', $report->summary) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Report::SPECIAL_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('special') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="special_{{ $key }}" name="special" value="{{ $key }}" {{ old('special', $report->special) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('evolving') ? 'is-invalid' : '' }}" type="number" name="evolving" id="evolving" value="{{ old('evolving', $report->evolving) }}" step="1">
