    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.studies.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('maximum_slots') ? 'is-invalid' : '' }}" type="number" name="maximum_slots" id="maximum_slots" value="{{ old('maximum_slots', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('time_per_slot') ? 'is-invalid' : '' }}" type="number" name="time_per_slot" id="time_per_slot" value="{{ old('time_per_slot', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('weightage') ? 'is-invalid' : '' }}" type="number" name="weightage" id="weightage" value="{{ old('weightage', '') }}" step="1">
