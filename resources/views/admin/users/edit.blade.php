    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\User::EXPIRABLE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('expirable') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="expirable_{{ $key }}" name="expirable" value="{{ $key }}" {{ old('expirable', $user->expirable) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('expires_on') ? 'is-invalid' : '' }}" type="text" name="expires_on" id="expires_on" value="{{ old('expires_on', $user->expires_on) }}">
