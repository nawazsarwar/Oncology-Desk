                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.comments.update", [$comment->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="body" id="body">{{ old('body', $comment->body) }}</textarea>
                            @if($errors->has('body'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="commentable_type" id="commentable_type" value="{{ old('commentable_type', $comment->commentable_type) }}" required>
