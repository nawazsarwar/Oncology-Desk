    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.patients.update", [$patient->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="registration_date">{{ trans('cruds.patient.fields.registration_date') }}</label>
                            <input class="form-control date" type="text" name="registration_date" id="registration_date" value="{{ old('registration_date', $patient->registration_date) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_mlc_patient" id="is_mlc_patient" value="1" {{ $patient->is_mlc_patient || old('is_mlc_patient', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="uhid_number" id="uhid_number" value="{{ old('uhid_number', $patient->uhid_number) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="abha" id="abha" value="{{ old('abha', $patient->abha) }}">
                            @if($errors->has('abha'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('abha') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mobile_number" id="mobile_number" value="{{ old('mobile_number', $patient->mobile_number) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="first_name" id="first_name" value="{{ old('first_name', $patient->first_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="middle_name" id="middle_name" value="{{ old('middle_name', $patient->middle_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="last_name" id="last_name" value="{{ old('last_name', $patient->last_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="dob" id="dob" value="{{ old('dob', $patient->dob) }}">
                            @if($errors->has('dob'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('dob') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="patient_age_in_years" id="patient_age_in_years" value="{{ old('patient_age_in_years', $patient->patient_age_in_years) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="patient_age_in_months" id="patient_age_in_months" value="{{ old('patient_age_in_months', $patient->patient_age_in_months) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="patient_age_in_days" id="patient_age_in_days" value="{{ old('patient_age_in_days', $patient->patient_age_in_days) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="identification_number" id="identification_number" value="{{ old('identification_number', $patient->identification_number) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="gurdian_name" id="gurdian_name" value="{{ old('gurdian_name', $patient->gurdian_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mlc_number" id="mlc_number" value="{{ old('mlc_number', $patient->mlc_number) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="police_station" id="police_station" value="{{ old('police_station', $patient->police_station) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mlc_remark" id="mlc_remark" value="{{ old('mlc_remark', $patient->mlc_remark) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_referred_patient" id="is_referred_patient" value="1" {{ $patient->is_referred_patient || old('is_referred_patient', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="referring_hospital" id="referring_hospital" value="{{ old('referring_hospital', $patient->referring_hospital) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="referring_department" id="referring_department" value="{{ old('referring_department', $patient->referring_department) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="reffered_on" id="reffered_on" value="{{ old('reffered_on', $patient->reffered_on) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="referring_uhid" id="referring_uhid" value="{{ old('referring_uhid', $patient->referring_uhid) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="remarks" id="remarks">{{ old('remarks', $patient->remarks) }}</textarea>
