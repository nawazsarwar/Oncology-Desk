                    ...
                    <form method="POST" action="{{ route("frontend.reports.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Report::SPECIAL_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="special_{{ $key }}" name="special" value="{{ $key }}" {{ old('special', 'No') === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="evolving" id="evolving" value="{{ old('evolving', '') }}" step="1">
