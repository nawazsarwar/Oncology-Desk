    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.studies.update", [$study->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="type" id="type" value="{{ old('type', $study->type) }}" required>
                            @if($errors->has('type'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('type') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $study->name) }}" required>
                            @if($errors->has('name'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('name') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="fee" id="fee" value="{{ old('fee', $study->fee) }}" step="0.01" required>
                            @if($errors->has('fee'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('fee') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="maximum_slots" id="maximum_slots" value="{{ old('maximum_slots', $study->maximum_slots) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="time_per_slot" id="time_per_slot" value="{{ old('time_per_slot', $study->time_per_slot) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="films" id="films" value="{{ old('films', $study->films) }}" step="1">
                            @if($errors->has('films'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('films') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="weightage" id="weightage" value="{{ old('weightage', $study->weightage) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="remarks" id="remarks">{{ old('remarks', $study->remarks) }}</textarea>
