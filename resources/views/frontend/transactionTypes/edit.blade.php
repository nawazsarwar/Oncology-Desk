                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.transaction-types.update", [$transactionType->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $transactionType->title) }}" required>
                            @if($errors->has('title'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="account" id="account" value="{{ old('account', $transactionType->account) }}" required>
