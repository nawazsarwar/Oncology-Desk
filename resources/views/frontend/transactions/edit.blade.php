                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.transactions.update", [$transaction->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="narration" id="narration" value="{{ old('narration', $transaction->narration) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date" id="date" value="{{ old('date', $transaction->date) }}" required>
                            @if($errors->has('date'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('date') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="transactionable_type" id="transactionable_type" value="{{ old('transactionable_type', $transaction->transactionable_type) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="remarks" id="remarks">{{ old('remarks', $transaction->remarks) }}</textarea>
