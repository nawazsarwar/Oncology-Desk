                    ...
                    <form method="POST" action="{{ route("frontend.users.update", [$user->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\User::EXPIRABLE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="expirable_{{ $key }}" name="expirable" value="{{ $key }}" {{ old('expirable', $user->expirable) === (string) $key ? 'checked' : '' }} required>
                                    <label for="expirable_{{ $key }}">{{ $label }}</label>
                                </div>
                            @endforeach
                            @if($errors->has('expirable'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('expirable') }}
                                </div>
                            @endif
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="expires_on" id="expires_on" value="{{ old('expires_on', $user->expires_on) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="department" id="department" value="{{ old('department', $user->department) }}">
